...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        ImageView imageView = findViewById(R.id.registergif);
        Glide.with(this).load(R.drawable.reggif).into(imageView);
    }
    /**
    ...
    private void postDataToSQLite() {
        ...
        if (!inputValidation.iSMobileNumberIsValid(textInputEditTextMobile, textInputLayoutMobile, getString(R.string.error_message_mobile))) {
            return;
        }
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
            ...
            emptyInputEditText();
            Intent intentRegister = new Intent(getApplicationContext(), Login.class);
